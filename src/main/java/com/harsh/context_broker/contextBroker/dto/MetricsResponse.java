...
public class MetricsResponse {
    ...
    public long getEscalationsToday() { return escalationsToday; }
    public void setEscalationsToday(long escalationsToday) { this.escalationsToday = escalationsToday; }

    public MetricsResponse(long total, long active, long critical, long stale, long resolved, long escalationsToday) {
        this.total = total;
        this.active = active;
